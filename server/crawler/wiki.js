...
export const fetchImageFromIMDb = async () => {
  let IMDbCharacters = require(resolve(__dirname, '../database/json/finalCharacters.json'))
...
// http://osm3xqbp6.bkt.cl/ouddn.com/nm0227759/bwtl5cngqct61vggqhqe6m7fvju1nbbs
